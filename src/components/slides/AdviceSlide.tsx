    ...
    <Slide>
      <div className="w-full max-w-5xl mx-auto text-center">
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-4xl font-bold mb-4 text-gradient">Advice & Takeaway</h2>
          <p className="text-2xl text-slate-300">"후배님들에게 전하고 싶은 이야기"</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-blue-400 mb-4">💡 다양한 언어로 '내 길' 찾기</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-purple-400 mb-4">🚀 기회는 실행하는 자의 것</h3>
